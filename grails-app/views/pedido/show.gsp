	...
	<body>
		...
		<div id="show-pedido" class="content scaffold-show" role="main">
			...
			<ol class="property-list pedido">
				...
				<g:if test="${pedidoInstance?.clientes}">
				<li class="fieldcontain">
					<span id="clientes-label" class="property-label"><g:message code="pedido.clientes.label" default="Clientes" /></span>
					
						<g:each in="${pedidoInstance.clientes}" var="c">
				...
				<li class="fieldcontain">
					<span id="datahora-label" class="property-label"><g:message code="pedido.datahora.label" default="Datahora" /></span>
