	...
	<body>
		...
		<div id="show-estoque" class="content scaffold-show" role="main">
			...
			<ol class="property-list estoque">
				...
				<g:if test="${estoqueInstance?.quantidadeMinima}">
				<li class="fieldcontain">
					<span id="quantidadeMinima-label" class="property-label"><g:message code="estoque.quantidadeMinima.label" default="Quantidade Minima" /></span>
					
						<span class="property-value" aria-labelledby="quantidadeMinima-label"><g:fieldValue bean="${estoqueInstance}" field="quantidadeMinima"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${estoqueInstance?.produto}">
				<li class="fieldcontain">
					<span id="produto-label" class="property-label"><g:message code="estoque.produto.label" default="Produto" /></span>
					
						<span class="property-value" aria-labelledby="produto-label"><g:link controller="produto" action="show" id="${estoqueInstance?.produto?.id}">${estoqueInstance?.produto?.encodeAsHTML()}</g:link></span>
